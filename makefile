...
proj4: Cipher.o Caesar.o RailFence.o Ong.o CipherTool.o Vigenere.o proj4.cpp
	$(CXX) $(CXXFLAGS) Cipher.o Caesar.o RailFence.o Ong.o CipherTool.o Vigenere.o proj4.cpp -o proj4

CipherTool.o: Cipher.o RailFence.o Caesar.o Ong.o CipherTool.h CipherTool.cpp
